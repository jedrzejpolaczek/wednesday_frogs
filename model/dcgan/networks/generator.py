...
def create_generator() -> tensorflow.keras.Model:
    """
    ...
    return (tensorflow.keras.Model): instation of untrained generator (CNN) model.
    """
    logger.debug("Load variables.")
    training_data = get_json_data('training_config.json')

    # Dimensions of your input shape. Note that your input shape has only one dimension, 
