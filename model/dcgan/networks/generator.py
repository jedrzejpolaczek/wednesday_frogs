...
def get_generator_loss(fake_output: tuple(list, list)) -> tensorflow.python.framework.ops.EagerTensor:
    """
    ...
    fake output (tuple(list, list)): fake output values from discriminator 
    contatining list with predictions and actuall values (eg. y_pred, y_true).

    return (tensorflow.python.framework.ops.EagerTensor): tensor with value of loss for fake output.
    """
...
def get_generator_optimizer() -> tensorflow.keras.optimizers.optimizer_v2.adam.Adam:
    """
